            ...
            <div id="datamhs">
                ...
                <div class="d-flex justify-content-center">
                    <table id="tabelmhs">
                        ...
                        $query = "SELECT * FROM tb_pkl JOIN tb_mhs where tb_pkl.nim = tb_mhs.nim ORDER BY tb_pkl.verif_pkl";
                        $connect = mysqli_query($conn, $query);
                        $no = 1;

                        if (isset($_GET['cari_mhs'])){
                            $nama_mhs = $_GET['nama_mhs'];
                            $query = "SELECT * FROM tb_pkl JOIN tb_mhs where tb_pkl.nim = tb_mhs.nim && tb_mhs.nama LIKE '%".$nama_mhs."%' ORDER BY tb_pkl.verif_pkl";
                            $connect = mysqli_query($conn, $query);
                            $no = 1;
                        }
